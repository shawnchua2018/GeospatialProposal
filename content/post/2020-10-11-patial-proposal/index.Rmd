...
![](/post/2020-10-11-patial-proposal/overview.PNG)

TAB 2: Feature Settings - Pick variables to be included in modelling and analysis<br />
Tab 2.1: Feature Selection
![](/post/2020-10-11-patial-proposal/feature select 1.PNG)
Tab 2.2: View Data
![](/post/2020-10-11-patial-proposal/feature select 2.PNG)
Tab 2.3: Analysis
![](/post/2020-10-11-patial-proposal/feature select 3.PNG)

TAB 3: GWR modelling<br />
Tab 3.1: Settings
![](/post/2020-10-11-patial-proposal/gwr 1.PNG)
Tab 3.2: Spatial Autocorrelation
![](/post/2020-10-11-patial-proposal/gwr 2.PNG)
Tab 3.3.1: Fixed GWR
![](/post/2020-10-11-patial-proposal/gwr 3.PNG)
Tab 3.3.2: Fixed GWR Data Output
![](/post/2020-10-11-patial-proposal/gwr 4.PNG)
